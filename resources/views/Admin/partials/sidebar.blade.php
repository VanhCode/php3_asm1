                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('posts.list') }}" class="nav-link" data-key="t-starter"> Danh sách tin tức </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('posts.create') }}" class="nav-link" data-key="t-team"> Thêm mới tin tức </a>
                            </li>
                        </ul>
                    </div>
                </li>
